// ============================================================
// FILE: assets/js/components/sidebar_deliverer.js
// PURPOSE: Sidebar for deliverer-role pages.
// ============================================================
...
function renderSidebar() {
    ...
    const navLinks = [
        { href: '/BOMS-EVAgas/public/deliverer/dashboard.html',  label: 'Dashboard',        icon: '▦' },
        { href: '/BOMS-EVAgas/public/deliverer/deliveries.html', label: 'My Deliveries',    icon: '🚴' },
    ];
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                <div class="sidebar-user">
                    <div class="user-avatar">${(user.name || 'D')[0].toUpperCase()}</div>
                    <div class="user-info">
                        <div class="user-name">${user.name || 'Deliverer'}</div>
